...
QT_MOC_LITERAL(1, 10, 20), // "currentMatrixChanged"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "DataLayer\0currentMatrixChanged\0"
};
...
void DataLayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DataLayer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->currentMatrixChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DataLayer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataLayer::currentMatrixChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DataLayer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_DataLayer.data,
    qt_meta_data_DataLayer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void DataLayer::currentMatrixChanged()
{
