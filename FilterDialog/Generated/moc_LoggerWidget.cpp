...
#include <memory>
#include "stdafx.h"
#include "../Dialog/LoggerView/LoggerWidget.h"
...
struct qt_meta_stringdata_LoggerModel_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LoggerModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LoggerModel_t qt_meta_stringdata_LoggerModel = {
    {
QT_MOC_LITERAL(0, 0, 11) // "LoggerModel"
...
static const uint qt_meta_data_LoggerModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject LoggerModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractItemModel::staticMetaObject>(),
    qt_meta_stringdata_LoggerModel.data,
    qt_meta_data_LoggerModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LoggerModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LoggerModel.stringdata0))
